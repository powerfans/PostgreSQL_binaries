...
# rpm -Uvh postgresql12-12.5-1PGDG.rhel8.src.rpm
...
# sed -i 's/^%prep/%define _debugsource_template %{nil}\n\n%prep/g' postgresql-12.spec
# rpmbuild -v -bb postgresql-12.spec --define='optflags -O3 -mcpu=native -mtune=native -mcmodel=large' --define='devtoolsetpath /opt/rh/gcc-toolset-9/root/usr' 2>&1 | tee build.log

# cd /root/rpmbuild/RPMS/ppc64le; tar zcf postgresql12-12.5-1PGDG.el8a.ppc64le_RPMS.tar.gz *.rpm
