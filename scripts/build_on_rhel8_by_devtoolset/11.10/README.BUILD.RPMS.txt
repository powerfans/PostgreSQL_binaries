...
# rpmbuild -v -bb postgresql-11.spec --define='optflags -O3 -mcpu=native -mtune=native -mcmodel=large' --define='devtoolsetpath /opt/rh/gcc-toolset-9/root/usr' 2>&1 | tee build.log
