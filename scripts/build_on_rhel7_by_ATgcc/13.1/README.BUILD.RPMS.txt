...
# rpmbuild -v -bb postgresql-13.spec --define='optflags -O3 -mcpu=native -mtune=native -mcmodel=large' --define='atpath /opt/at11.0' --define='atstring at11.0' 2>&1 | tee build.log 
